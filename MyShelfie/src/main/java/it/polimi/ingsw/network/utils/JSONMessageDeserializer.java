...
public class JSONMessageDeserializer {
    ...
    public static Message deserializeMessage(String messageJSON) {
        ...
        switch (m.getType()) {
            ...
            case GAME_START -> {return new Deserializer<GameStartMessage>().deserialize(messageJSON, GameStartMessage.class);} //TODO INCOMPLETED CLASS
    ...
    static class Deserializer<T> {
        public T deserialize(String messageJSON, Class<T> type) {
